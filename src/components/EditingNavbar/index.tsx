...
const EditingNavbar = () => {
	...
	return (
		<>
			<nav className="nav-shadow flex z-20 relative justify-between justify-center items-center h-[48px] px-[6px] pl-0 bg-[#0E1525]">
				{/* Header Left */}
				...
				<div className="flex-grow flex justify-center items-center">
					<button disabled={processing} onClick={handleSubmission} className={`translate-x-1/2 w-fit flex items-center justify-center rounded-[4px] h-[32px] p-2 text-[#BFFFCA] !px-[12px] ${!processing ? "bg-[#044A10] border-transparent hover:text-white hover:bg-[#009118]" : "!px-2 bg-[#2B3245] text-[#C2C8CC] hover:text-white hover:bg-[#3C445C]" }`}>
						{processing ?
