		...
		<>
			<nav className="nav-shadow flex z-20 relative shrink-0 items-center h-[48px] px-[12px] pl-0 bg-[#0E1525]">
				...
				<div className="transition-all duration-300 ease-in-out flex  grow-1 gap-[4px] items-center">
					{/* <button onClick={handleClick} className="transition-all duration-200 ease-in-out text-[hsl(0,0%,80%)] bg-[#0000] font-[400] items-center rounded-[6px] border-[1px] border-[#0000] flex gap-[6px] h-[32px] px-[10px] text-[13px] hover:border-[hsl(220,60%,95%)]/[0.14] hover:bg-[hsl(220,60%,95%)]/[0.1]">
				...
				{/* Header Right */}
				{
					<div className="flex items-center ml-auto gap-[8px]">
						...
						<div className="h-full relative">
							<button className=" transition-all duration-200 ease-in-out text-white bg-[#1C2333] font-[400] items-center rounded-[6px] border-[1px] border-[#0000] flex gap-[8px] h-[32px] px-[10px] text-[13px] hover:border-[hsl(220,60%,95%)]/[0.14] hover:bg-[hsl(220,60%,95%)]/[0.1]">
