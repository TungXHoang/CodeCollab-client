...
const ShareModal = ({ onClose, project }: IShareModalProps) => {	
	...
	const handleShare = async (e: React.MouseEvent<HTMLButtonElement>) => {
		...
		showShareToast(res!.status, res!.data.message); 
		return res;
	}
	...
	return (
		<div className="cursor-auto bg-[#000000bf] top-0 right-0 bottom-0 right-0 overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none"
			onClick={handleClose}>
