								...
								<div className="p-[20px] pt-0 text-[hsl(0,0,80%)] flex flex-col ">
									...
									<div className="flex text-[hsl(0,0,80%)] ">
										<span className="w-[417px] text-[14px]">
											<input autoComplete="off" required name="email" placeholder="Enter email..." className="text-[13px] outline-none focus:border-[#0079F2] px-2 py-1 w-full bg-[#2B3245] border-[1px] border-[#3C445C] hover:border-[#5F677A] rounded-[4px]" type="email" value={shareUser} onChange={(e) => setShareUser(e.currentTarget.value)} />
										</span>
										<button onClick={handleShare} className="flex font-[500] items-center text-[13px] ml-[8px] bg-[#0053A6] hover:bg-[#0079F2] text-[#F5F9FC] p-[5px] pl-0 shrink-0 flex-grow rounded-[4px]">
