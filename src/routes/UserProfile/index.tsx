	...
	return (
		<>
			...
			userProfile &&
							...
							<div className="w-[240px] bg-[#0E1525] border-r-[1px] border-[#2B3245]">	
								<section className="text-[13px] font-[400] leading-[1.3] p-[24px]">
									<header className="mb-[16px] pb-[16px] border-b-[1px] border-[#2B3245]">
										<img className="w-[180px] h-[180px] " src={userProfile.thumbnailUrl}></img>
										<h2 className="text-[18px] font-[600] leading-[1.3] mt-[16px] text-[hsl(0,0%,95%)]">{userProfile.firstName}{userProfile.lastName}</h2>
										<p className="text-[16px] font-[400] mt-[8px] text-[hsl(0,0%,80%)]">{userProfile.email}</p>
									</header>
				...
				{showModal && <EditProfileModal user={user} userProfile={userProfile} onClose={()=>setShowModal(false)} /> }
					</div>
			}
		</>
